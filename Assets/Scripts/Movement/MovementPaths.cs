...
public class MovementPaths {
	...
	public static List<Vector3> CreateSnakePath(Vector3 startingPos, int levels = 4, float distanceBetweenLevels = 2, float levelWidth = 3,
		...
		for (int i = 0; i < levels; i++) {
			pathList.Add(startingPos + new Vector3(0, i * distanceBetweenLevels));
			pathList.Add(startingPos + new Vector3(levelWidth, i * distanceBetweenLevels));
			pathList.Add(startingPos + new Vector3(levelWidth, i * distanceBetweenLevels + distanceBetweenLevels / 2));
			pathList.Add(startingPos + new Vector3(0, i * distanceBetweenLevels + distanceBetweenLevels / 2));
		}
